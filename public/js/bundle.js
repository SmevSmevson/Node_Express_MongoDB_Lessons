    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_hxLkNFIeccwtJ4Cqy3PpqaGx00e62bHJ7s'); //1) Get checkout session from API
          ...
          case 4:
            ...
            console.log(session); //2) Create chackout form + change credit card
...
var bookBtn = document.getElementById('book-tour'); //DELEGATIOM
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              document.getElementById('password-confirm').value = ''; // btn--save-password
